...
const Hero = () => {
  return (
    <div className="flex min-h-[860px] flex-col bg-[url('/hero.jpg')] bg-cover bg-center bg-no-repeat xl:min-h-[900px] 2xl:h-[950px]">
      <Navbar />
      <div className="px-20 xl:px-[56px] 2xl:px-10 xl:mt-[70px] 2xl:mt-[88px] mt-[70px]">
        <div className="mx-auto flex w-full max-w-[1440px] ">
          <div className="flex w-full flex-col pt-[] items-center justify-center rounded-[28px] border border-accent/10 bg-tertiary/3 px-6 py-12 backdrop-blur-[7px] lg:min-h-[560px] lg:px-10 xl:min-h-[620px] xl:rounded-[40px] 2xl:min-h-[698px]">
